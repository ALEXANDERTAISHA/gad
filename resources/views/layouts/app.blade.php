        ...
        <div class="partner-slider-one pt-80 pb-70 border-top-1 wow fadeInUp">
            <div class="single-partner-item">
                <div class="partner-img">
                    <a href="#"><img src="assets/images/banerpiedepagina/presidencia.png" alt="Partner Image"></a> 
                </div>
            </div>
            <div class="single-partner-item">
                <div class="partner-img">
                    <a href="#"><img src="assets/images/banerpiedepagina/conagopare.png" alt="Partner Image"></a>
                </div>
            </div>
            <div class="single-partner-item">
                <div class="partner-img">
                    <a href="#"><img src="assets/images/banerpiedepagina/senplades.png" alt="Partner Image"></a>
                </div>
            </div>
            <div class="single-partner-item">
                <div class="partner-img">
                    <a href="#"><img src="assets/images/banerpiedepagina/mies.png" alt="Partner Image"></a>
                </div>
            </div>
            <div class="single-partner-item">
                <div class="partner-img">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                ...
                                <div class="footer-widget footer-about-widget mb-40 pr-lg-70 wow fadeInDown">
                                    <div class="widget-content">
                                        ...
                                        <a href="{{ route('contacto') }}" class="main-btn filled-btn filled-white">Contacto</a>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="copyright-text">
                                    <p>Copy&copy; {{ date('Y') }} <a href="https://www.facebook.com/DKFLSGDSFGDSFGDSFGFDS/photos/a.116380479943809/325347255713796/">Taisha Technology.</a> Todos derechos reservados.</p>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <!--====== Copyright Nav ======-->
