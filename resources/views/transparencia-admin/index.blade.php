...
<div class="container mt-2">
    <div class="row">
                    ...
                    <form action="{{ route('guardar-archivo-transparencia') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label  for="transparencia"><b>Seleccione Transparencia</b></label>
                                <div class="select">
                            ...
                            <div class="form-group col-md-6">
                                <label for="mes"><b>Seleccione mes</b></label>
                                <div class="select">
                        ...
                        <div class="form-group">
                            <label for="nombre"><b>Título del archivo</b></label>
                            <input type="text" name="nombre" value="{{ old('nombre') }}" class="form-control" id="nombre">
                        </div>

                        <div class="form-group">
                            <label for="archivo"><b>Seleccione el archivo .PDF</b></label>
        ...
        <div class="col-md-6 my-2">
            <div class="card">
                <div class="card-header">
                    <b>Transparencia & Rendicion de cuentas</b>
                </div>
                <div class="card-body">
